 ...
 * @since 2014-6-2
 */
public final class old_ArrayUtil {
	...
	public static final byte[] asArray(byte... bytes) {
		return bytes;
	}


	public static final short[] asArray(short... shorts) {
		return shorts;
	}


	public static final char[] asArray(char... chars) {
		return chars;
	}


	public static final int[] asArray(int... ints) {
		return ints;
	}


	public static final long[] asArray(long... longs) {
		return longs;
	}


	public static final float[] asArray(float... floats) {
		return floats;
	}


	public static final double[] asArray(double... doubles) {
		return doubles;
	}


	@SafeVarargs
	public static final <T> T[] asArray(T... ts) {
		return ts;
	}
	 ...
	 * @see old_ArrayUtil#and(byte[], int, byte[], int, byte[], int, int) and()
	 */
	 ...
	 * @see old_ArrayUtil#or(byte[], int, byte[], int, byte[], int, int) or()
	 */
	 ...
	 * @see old_ArrayUtil#xor(byte[], int, byte[], int, byte[], int, int) xor()
	 */
