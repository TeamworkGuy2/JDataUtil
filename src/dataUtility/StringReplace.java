...
public final class StringReplace {
	...
	public static final String replaceEscapeLiterals(String str) {
		...
		while(index > -1) {
			if(index + 1 >= converted.length() ||
					(escapeIdIndex = ArrayUtil.indexOf(escapeIdentifiers, converted.charAt(index + 1))) == -1) {
				break;
			}
	 ...
	 */
	public static String replaceStrings(String content, int contentOffset, String search, String replace) {
		if(content.indexOf(search) == -1) {
			return content;
		}
		StringBuilder validated = new StringBuilder(content);
		int index = 0;
		index = validated.indexOf(search, contentOffset);
		while(index > -1) {
	 ...
	 */
	public static int replaceStrings(char[] content, int contentOffset, String search, String replace, StringBuilder dst) {
	...
	public static final String replaceTokens(String str, Comparator<Map.Entry<String, String>> comparator,
		...
		String prefix = StringTransformIo.commonPrefix(0, tokens);
		if(prefix.length() > 0) {
