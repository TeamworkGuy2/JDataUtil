 ...
 * @since 2014-10-29
 */
public final class IntRangeSearcherMutableImpl implements CharRangeSearcherMutable, IntRangeSearcherMutable {
	IntArrayList rangePoints;
	...
	public IntRangeSearcherMutableImpl(IntList rangePoints) {
		this(rangePoints, false, true, false);
	}


	public IntRangeSearcherMutableImpl(IntList rangePoints, boolean locked,
	...
	public IntRangeSearcherMutableImpl(CharRangeSearcherMutable src) {
		this(src, false, true, src instanceof IntRangeSearcherMutableImpl ?
				((IntRangeSearcherMutableImpl)src).combineOverlap : false);
	}


	public IntRangeSearcherMutableImpl(CharRangeSearcherMutable src, boolean locked,
			boolean throwErrorIfEqualRangeExists, boolean combineOverlappingRanges) {
		this(locked, throwErrorIfEqualRangeExists, combineOverlappingRanges);
	...
	public IntRangeSearcherMutableImpl(boolean locked, boolean throwErrorIfEqualRangeExists,
		...
		this.rangePoints = new IntArrayList();
		this.locked = locked;
	...
	public CharRangeSearcher toImmutableCharRangeSearcher() {
		return new IntRangeSearcherMutableImpl(this, true, true, false);
	}
